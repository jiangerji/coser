...
public class MediaPicker {
     ...
     * Set folder Name
     *
     * @param albumName default folder name is Camera.
     */
     ...
     *
     * @param showCamera boolean value.To set visibility of camera/video button.
     *                   default its visible.
     */
     ...
     *
     * @param size int file size in mb. default is set to 20 mb.
     */
     ...
     *
     * @param limit int value. Default is 9.
     */
